...
export function Databases() {
  ...
  const handleDatabaseStop = async (db: DatabaseInstance) => {
    try {
      await new Promise(resolve => setTimeout(resolve, 1000));
  ...
  const handleDatabaseRestart = async (db: DatabaseInstance) => {
    try {
  ...
  const handleDatabaseConfig = (db: DatabaseInstance) => {
    warning('Fonctionnalité', `Configuration de la base de données ${db.name} - À implémenter`);
  };
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex space-x-1">
                    <Button
                      ...
                      size="sm"
                      className="p-1"
                      onClick={() => success('Information', `Affichage des détails de la base de données ${db.name}`)}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="p-1"
                      onClick={() => warning('Fonctionnalité', `Édition de la base de données ${db.name} - À implémenter`)}
                    >
